...
public class AnnotationConfig extends GenericWebApplicationContext implements AnnotationConfigRegistry{

	protected final AnnotatedBeanDefinitionReader reader;

	protected final ClassPathBeanDefinitionScanner scanner;

	protected final Set<Class<?>> annotatedClasses = new LinkedHashSet<>();
	 ...
	 */
	public AnnotationConfig(DefaultListableBeanFactory beanFactory) {
		super(beanFactory);
		this.reader = new AnnotatedBeanDefinitionReader(this);
		this.scanner = new ClassPathBeanDefinitionScanner(this);
	}
	 ...
	 * classes
	 */
	public AnnotationConfig(Class<?>... annotatedClasses) {
		this();
	 ...
	 */
	public AnnotationConfig(String... basePackages) {
		this();
		scan(basePackages);
		refresh();
	}
